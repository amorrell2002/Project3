...
County::County(json& fileDemographics, json& fileFoodData)
{
    ...
    vehicleAccessOneMile = fileFoodData["Vehicle Access"]["1 Mile"]/population2010 * 100;
    vehicleAccessHalfMile = fileFoodData["Vehicle Access"]["1/2 Mile"]/population2010 * 100;
    vehicleAccessTenMile = fileFoodData["Vehicle Access"]["10 Miles"]/population2010 * 100;
    vehicleAccessTwentyMile = fileFoodData["Vehicle Access"]["20 Miles"];
    kidsBeyondOneMile = fileFoodData["Low Access Numbers"]["Children"]["1 Mile"]/population2010 * 100;
    kidsBeyondHalfMile = fileFoodData["Low Access Numbers"]["Children"]["1/2 Mile"]/population2010 * 100;
    kidsBeyondTenMile = fileFoodData["Low Access Numbers"]["Children"]["10 Miles"]/population2010 * 100;
    kidsBeyondTwentyMile = fileFoodData["Low Access Numbers"]["Children"]["20 Miles"]/population2010 * 100;
    lowIncomeBeyondOneMile = fileFoodData["Low Access Numbers"]["Low Income People"]["1 Mile"]/population2010 * 100;
    lowIncomeBeyondHalfMile = fileFoodData["Low Access Numbers"]["Low Income People"]["1/2 Mile"]/population2010 * 100;
    lowIncomeBeyondTenMile = fileFoodData["Low Access Numbers"]["Low Income People"]["10 Miles"]/population2010 * 100;
    lowIncomeBeyondTwentyMile = fileFoodData["Low Access Numbers"]["Low Income People"]["20 Miles"]/population2010 * 100;
    popBeyondOneMile = fileFoodData["Low Access Numbers"]["People"]["1 Mile"]/population2010 * 100;
    popBeyondHalfMile = fileFoodData["Low Access Numbers"]["People"]["1/2 Mile"]/population2010 * 100;
    popBeyondTenMile = fileFoodData["Low Access Numbers"]["People"]["10 Miles"]/population2010 * 100;
    popBeyondTwentyMile = fileFoodData["Low Access Numbers"]["People"]["20 Miles"]/population2010 * 100;
    seniorsBeyondOneMile = fileFoodData["Low Access Numbers"]["Seniors"]["1 Mile"]/population2010 * 100;
    seniorsBeyondHalfMile = fileFoodData["Low Access Numbers"]["Seniors"]["1/2 Mile"]/population2010 * 100;
    seniorsBeyondTenMile = fileFoodData["Low Access Numbers"]["Seniors"]["10 Miles"]/population2010 * 100;
    seniorsBeyondTwentyMile = fileFoodData["Low Access Numbers"]["Seniors"]["20 Miles"]/population2010 * 100;
